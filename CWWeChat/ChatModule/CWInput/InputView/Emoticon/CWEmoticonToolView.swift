...
protocol CWEmoticonToolViewDelegate {
    
}

/// 表情标签
class CWEmoticonToolView: UIView {

    var delegate: CWEmoticonToolViewDelegate?
    /// 数据源
    var groupList: [CWEmoticonGroup] = [CWEmoticonGroup]()
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(CWEmoticonToolItemCell.self, forCellWithReuseIdentifier: "cell")
...
extension CWEmoticonToolView: UICollectionViewDelegate {
...
extension CWEmoticonToolView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! CWEmoticonToolItemCell
